...
DOWNLOAD_DIR = '/home/ec2-user/alphafold_test/alphafold_data'

# Name of the AlphaFold Docker image.
docker_image_name = 'alphafold'

# Path to a directory that will store the results.
output_dir = '/home/ec2-user/alphafold_test/alphafold_test'
...
flags.DEFINE_boolean('load_pkl', False, 'Load features dict from pre-calculated '
                     '.pkl files')
